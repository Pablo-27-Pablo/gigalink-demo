    ...
    <main className="bg-white w-full selection:bg-[#43bbab]/20 overflow-x-hidden text-slate-900">
        ...
        <div className="relative z-20 text-center px-4">
          ...
          >
            <div className="relative w-[350px] md:w-[900px] aspect-[2/1]">
              <Image src={logo} alt="GigaLink Logo" fill priority className="object-contain" />
            </div>
            <motion.div
            ...
            >
              <p className="text-slate-400 text-xs md:text-sm font-medium tracking-[0.8em] uppercase">The Future of Connectivity</p>
              <div className="flex items-center gap-6">
                 <div className="h-[1px] w-16 bg-[#43bbab]/40" />
                 <span className="text-slate-900 text-xl md:text-3xl font-light tracking-[0.2em] uppercase">Coming Soon</span>
                 <div className="h-[1px] w-16 bg-[#43bbab]/40" />
              </div>
            </motion.div>
          </motion.div>
      ...
      <section className="min-h-screen w-full flex items-center relative py-32 px-6 md:px-24 bg-slate-50 border-y border-slate-100">
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          ...
          >
            <span className="text-[#43bbab] font-mono tracking-[0.3em] text-sm uppercase font-bold">01 // High-Speed Access</span>
            <h2 className="text-slate-900 text-5xl md:text-8xl font-black tracking-tighter leading-[0.95]">
              High Speed <br />
              <span className="text-slate-300 italic font-light">Everywhere.</span>
            </h2>
            <p className="text-slate-500 text-xl md:text-2xl leading-relaxed max-w-xl font-light">
              GigaLink delivers fiber-like speeds via Starlink's global satellite constellation, managed by ComClark.
            </p>
            <div className="flex flex-col gap-6">
              {["No monthly subscriptions required", "QR Voucher activation", "Inquiries: inquiry@comclark.com.ph"].map((text, i) => (
                <div key={i} className="flex items-center gap-6 text-slate-800 group">
          ...
          >
            <div className="relative z-10 rounded-[3rem] overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.1)] border-[12px] border-white bg-white">
              <Image src={satelliteImg} alt="GigaLink High Speed Internet" className="w-full h-auto rounded-[2rem]" />
            </div>
      ...
      <section className="py-32 px-6 md:px-24 bg-white min-h-screen flex flex-col justify-center">
        <div className="max-w-[1400px] mx-auto w-full">
          <motion.div 
            ...
            className="mb-20"
          >
            <h2 className="text-slate-900 text-5xl md:text-7xl font-bold tracking-tight">Frequently Asked <span className="text-[#43bbab] font-serif italic font-light">Questions</span></h2>
          ...
          <div className="space-y-4">
            {faqData.map((faq, index) => (
              ...
              >
                ...
                >
                  <span className={`text-2xl md:text-3xl font-medium transition-colors ${activeFaq === index ? 'text-[#43bbab]' : 'text-slate-900'}`}>
                    {faq.q}
                  </span>
                  <div className={`w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center transition-all duration-300 ${activeFaq === index ? 'rotate-180 bg-[#43bbab] border-[#43bbab] text-white shadow-lg shadow-[#43bbab]/20' : 'group-hover:border-[#43bbab]'}`}>
      ...
      <section className="py-32 bg-slate-900 flex flex-col items-center justify-center px-6 relative overflow-hidden">
         ...
         >
           <h3 className="text-white text-4xl md:text-6xl font-bold mb-6 tracking-tight">Ready to Link Up?</h3>
           <p className="text-slate-400 text-xl mb-6 font-light">Join the future of global connectivity.</p>
           
           {/* Inquiry Email Display */}
           <a href="mailto:inquiry@comclark.com.ph" className="text-[#43bbab] text-lg md:text-xl font-mono mb-12 block hover:underline transition-all">
             inquiry@comclark.com.ph
           </a>

           <div className="flex flex-col md:flex-row gap-4 w-full max-w-2xl mx-auto">
              <input type="email" placeholder="Enter your email for updates" className="flex-1 bg-white/5 border border-white/10 px-10 py-5 rounded-full text-white outline-none focus:ring-2 focus:ring-[#43bbab]/50 transition-all text-lg" />
